...
def write_to_postgres(batch_df, batch_id):
    ...
    if batch_df.count() > 0:
        ...
        # Cache batch_df tĩnh để tối ưu write
        ...
        batch_df_cached.unpersist()  # Giải phóng memory
    else:
        print(f"Batch {batch_id}: No records to process")

if __name__ == "__main__":
    from pyspark.sql import SparkSession
    jdbc_url = os.getenv("JDBC_URL", "jdbc:postgresql://postgres-service:5432/weather_db")
    ...
    query = aggregated_df.writeStream \
        ...
        .outputMode("update") \
        .option("checkpointLocation", "/opt/spark/checkpoint_new") \
        .start()
